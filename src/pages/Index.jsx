          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-2">
                <li><Badge variant="outline">Independent</Badge></li>
                <li><Badge variant="outline">Curious</Badge></li>
                <li><Badge variant="outline">Agile</Badge></li>
                <li><Badge variant="outline">Affectionate</Badge></li>
                <li><Badge variant="outline">Playful</Badge></li>
              </ul>
            </CardContent>
          </Card>
        </div>
